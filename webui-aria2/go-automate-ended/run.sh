...
#--net=host 
docker run -ti --rm -v /downloads/aria2/Downloads:/downloads -v /downloads/aria2/Ended:/ended -v /downloads/aria2/Extract:/extract -v pico-atrier:/nfs --name go-automated-ended poppypop/go-automated-ended /bin/sh