...
#debian
mkdir ${BASEDIR}
curl -X GET http://pki.moot.fr:8887/int.pem | tee ${BASEDIR}/Moot.fr_INT.pem  > /dev/null
curl -X GET http://pki.moot.fr:8887/ca.pem | tee ${BASEDIR}/Moot.fr_CA.pem  > /dev/null
