...
openssl pkcs12 -export -out pki/publish/server/$1/$1.p12 -inkey pki/publish/server/$1/$1.key -in pki/publish/server/$1/$1.crt -certfile pki/publish/ca.crt -passout pass:
