...
#docker run -ti --rm -v /etc/ssl/private:/etc/ssl/private:ro -p 389:389 -p 636:636 --name ldap poppypop/ldap $1

docker run -ti --rm -v openldap-data:/var/lib/openldap/openldap-data -v /etc/ssl/private:/etc/ssl/private:ro -p 389:389 -p 636:636 --name ldap poppypop/ldap $1
