...
echo "CHANGE MASTER 'pi1' TO MASTER_HOST='192.168.0.238', MASTER_PORT=3306,MASTER_USER='replication', MASTER_PASSWORD='yqTOksHDSGTy' ;" | mysql -u root -p6wObbPbBTaps -h 127.0.0.1
